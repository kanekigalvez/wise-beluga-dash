...
import { Menu, Search, Car, Download, Home, Wrench, Package, X, Newspaper, MessageSquareText, Code2, Laptop } from "lucide-react";
...
export const Header = () => {
  ...
  const navLinks = [
    ...
    { href: "/#software-custom", text: t('header.software_custom'), icon: <Laptop className="mr-2 h-4 w-4" /> },
    { href: "/#software-free", text: t('header.software_free'), icon: <Code2 className="mr-2 h-4 w-4" /> },
