      ...
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <p className="text-muted-foreground text-lg text-center leading-relaxed">
            <Trans i18nKey="compatibility.main_text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <StatCard icon={<Car className="h-6 w-6" />} value="+240" label={t('compatibility.stat1_label')} />
          <StatCard icon={<Truck className="h-6 w-6" />} value="+80" label={t('compatibility.stat2_label')} />
          <StatCard icon={<Zap className="h-6 w-6" />} value="+60" label={t('compatibility.stat3_label')} />
        </div>
        <div className="text-center mt-12">
          <p className="text-muted-foreground">
            <Trans i18nKey="compatibility.secondary_text">
