        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">Verificar Conector</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Buscar código DTC</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Conectores compatibles</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Soporte Técnico</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@diagzone.pro" className="hover:text-foreground transition-colors">info@diagzone.pro</a>
              </li>
              <li className="flex items-center gap-2">
