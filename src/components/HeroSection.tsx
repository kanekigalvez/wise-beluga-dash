...
export const HeroSection = () => {
  return (
    <section id="inicio" className="relative min-h-[700px] flex items-center overflow-hidden bg-gradient-hero">
      <div className="absolute inset-0 z-0 opacity-10" style={{ backgroundImage: `url(/placeholder.svg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
